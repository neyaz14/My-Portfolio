                ...
                <div className="max-w-6xl flex flex-col md:flex-row items-center gap-10 w-full">
                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row gap-5 justify-center md:justify-start">
                            <button className="btn  w-full sm:w-auto btn-neon">Resume</button>
                            <button className="btn btn-outline w-full sm:w-auto btn-neon">Contact</button>
                        </div>
                        <div className="flex gap-2 flex-wrap justify-center md:justify-start mt-4">
                            {["React", "Javascript", "Express Js", "Node.js", "MongoDB"].map((tech, index) => (
                                <span key={index} className="badge badge-outline px-6 py-4 bg-white bg-opacity-15 btn-neon text-sm sm:text-base">{tech}</span>
                            ))}
                        </div>
                    </motion.div>
                    <motion.div
                    ...
                    >
                        <img src={Me} alt="Tech Illustration" className="w-48 sm:w-64 md:w-80 lg:w-96" />
                    </motion.div>
                </div>
            </section>
        </div>
